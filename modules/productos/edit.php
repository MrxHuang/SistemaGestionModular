...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($nombre_err) && empty($precio_err) && empty($cantidad_err) && empty($categoria_id_err)) {
        ...
        $sql = "UPDATE productos SET nombre = :nombre, descripcion = :descripcion, precio = :precio, cantidad = :cantidad, categoria_id = :categoria_id, proveedor_id = :proveedor_id WHERE id = :id";
...
<div class="container px-6 py-8 mx-auto">
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="?module=productos&page=edit&id=<?php echo $id; ?>" method="post">
