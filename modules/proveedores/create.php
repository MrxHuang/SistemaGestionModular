...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($nombre_err)) {
        ...
        $sql = "INSERT INTO proveedores (nombre, nit, direccion, ciudad, telefono, email) VALUES (:nombre, :nit, :direccion, :ciudad, :telefono, :email)";
...
<div class="container px-6 py-8 mx-auto">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-semibold text-gray-800">Crear Nuevo Proveedor</h2>
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="?module=proveedores&page=create" method="post">
