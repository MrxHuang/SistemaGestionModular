...
<head>
    ...
    <title>Acceso Prohibido - Sistema de Gestión</title>
    <!-- Tailwind CSS -->
        ...
        <div class="bg-red-800 text-white py-4 px-6">
            <div class="flex items-center justify-center">
                ...
                <div>
                    ...
                    <p class="text-sm text-red-300">Error 403</p>
                </div>
            </div>
        </div>
        
        <div class="py-12 px-8 text-center">
            <div class="text-6xl font-bold text-red-800 mb-4">403</div>
            <h2 class="text-2xl font-semibold text-gray-800 mb-2">Acceso Prohibido</h2>
            <p class="text-gray-600 mb-8">Lo sentimos, no tienes permisos para acceder a esta página.</p>
            
            <div class="flex justify-center">
                <a href="index.php" class="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-6 rounded-lg">
                    Volver al inicio
                </a>
            </div>
        </div>
